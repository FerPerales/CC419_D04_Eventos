...
<html lang="es">
	...
	<div class="formulario">
			<form action="alta_Evento.php" method="get" name="reg_event" enctype="multipart/form-data" >
				<div>
				...
				<textarea id="textarea" rows="8" cols="80" wrap="hard" required placeholder="Escriba aqu&iacute"></textarea>
				...
				<div id="info">
					...
					<select name="cat" >
						...
						<option value="4"> Convivio</option>						
					</select>
